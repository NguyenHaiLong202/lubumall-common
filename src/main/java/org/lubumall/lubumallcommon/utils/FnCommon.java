package org.lubumall.lubumallcommon.utils;
...
import org.lubumall.lubumallcommon.exceptions.ExceptionLb;
...
public class FnCommon {
  ...
  public static <T extends Enum<T>> T getEnumValueFromString(Class<T> enumType, String name) {
    ...
    throw new ExceptionLb(HttpStatus.BAD_REQUEST, "Invalid state");
  }
  ...
  public static List<Long> stringToListLong(String ids) {
    ...
    try {
      ...
      throw new ExceptionLb(HttpStatus.BAD_REQUEST, "param ids invalid");
    }
  }
